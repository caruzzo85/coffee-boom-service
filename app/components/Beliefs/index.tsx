        ...
        <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl'>
            ...
            <div className="bg-build-2 py-10 px-10 sm:px-18 md:pb-70 rounded-3xl">
                ...
                <div className="bg-build py-10 px-10 sm:px-18 md:pb-70 rounded-3xl">
                   <h3 className="muvokan-tekstas text-4xl sm:text-50xl font-bold text-white leading-snug mb-5 text-center p-2 content-center opacity-80 rounded-2xl">Встановлення автоматичних кавоварок</h3>
                </div>
